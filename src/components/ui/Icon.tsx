...
export function SunIcon({ size = 18, style }: IconProps) {
  return (
    <svg {...base(size)} style={style} aria-hidden>
...
export function MoonIcon({ size = 18, style }: IconProps) {
  return (
    <svg {...base(size)} style={style} aria-hidden>
      <path d="M20 14.2A8.5 8.5 0 119.8 4a6.7 6.7 0 0010.2 10.2z" />
    </svg>
  );
}
